...
print("")
print("Discriminative Training of RAT-SPNs on higgs")
print("")
...
base_result_path = "results/ratspn/higgs/"

structure_dict = {}

# depth 1
structure_dict[1] = [
    {'num_recursive_splits': 10, 'num_input_distributions':  7, 'num_sums': 10},
    {'num_recursive_splits': 16, 'num_input_distributions': 10, 'num_sums': 10},
    {'num_recursive_splits': 20, 'num_input_distributions': 14, 'num_sums': 10},
    {'num_recursive_splits': 23, 'num_input_distributions': 20, 'num_sums': 10}]

# depth 2
structure_dict[2] = [
    {'num_recursive_splits': 10, 'num_input_distributions': 10, 'num_sums': 5},
    {'num_recursive_splits': 15, 'num_input_distributions': 14, 'num_sums': 10},
    {'num_recursive_splits': 20, 'num_input_distributions': 20, 'num_sums': 15},
    {'num_recursive_splits': 40, 'num_input_distributions': 25, 'num_sums': 20}]

# depth 3
structure_dict[3] = [
    {'num_recursive_splits':  9, 'num_input_distributions': 10, 'num_sums':  5},
    {'num_recursive_splits': 16, 'num_input_distributions': 12, 'num_sums': 10},
    ...
    for split_depth in structure_dict:
        for structure_config in structure_dict[split_depth]:
            for config_dict in param_configs:
                ...
                cmd += " --data_set higgs --data_path data/higgs/"
                cmd += " --low_variance_threshold -1.0"
                cmd += " --normalization none"
