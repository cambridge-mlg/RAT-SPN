...
print("")
print("Discriminative Training of RAT-SPNs on wine")
print("")
...
base_result_path = "results/ratspn/wine/"

structure_dict = {}

# depth 1
structure_dict[1] = [
    {'num_recursive_splits':  5, 'num_input_distributions': 10, 'num_sums': 10},
    {'num_recursive_splits':  8, 'num_input_distributions': 12, 'num_sums': 10},
    {'num_recursive_splits': 13, 'num_input_distributions': 14, 'num_sums': 10}]

# depth 2
structure_dict[2] = [
    {'num_recursive_splits':  5, 'num_input_distributions': 10, 'num_sums': 10},
    {'num_recursive_splits': 10, 'num_input_distributions': 15, 'num_sums': 14},
...
structure_dict[3] = [
    ...
    {'num_recursive_splits': 11, 'num_input_distributions': 15, 'num_sums': 10},
    {'num_recursive_splits': 20, 'num_input_distributions': 20, 'num_sums': 13}]
